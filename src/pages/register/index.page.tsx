import { Button, Heading, MultiStep, Text, TextInput } from "@project-design-system-ui/react";
...
export default function Register() {
    ...
    return (
        <Container>
            <Header>
                <Heading as="strong">
                    Bem-vindo  ao Book a time!
                </Heading>
                <Text>
                    Precisamos de algumas informações para criar seu perfil!
                    Ah, você pode editar estas informações depois.
                </Text>
            ...
            <Form as='form' onSubmit={handleSubmit(handleRegister)}>
                <label>
                    ...
                    <TextInput prefix="dominio.com/" placeholder='seu-usuario' {...register('username')} />
